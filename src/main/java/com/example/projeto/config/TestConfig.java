...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2025-03-12T12:02:23Z"), u1);
        Order o2 = new Order(null, Instant.parse("2025-02-12T13:04:23Z"), u2);
        Order o3 = new Order(null, Instant.parse("2025-01-15T15:05:33Z"), u1);
        Order o4 = new Order(null, Instant.parse("2025-03-22T18:10:23Z"), u3);
